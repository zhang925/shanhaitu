...
<html>
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="activityPicturesController.do?save">
		...
		<fieldset class="step">
			...
			<div class="form">
		      ...
		      <input class="inputxt" style="width: 350px;" id="pictureUrl" name="pictureUrl" ignore="ignore"   value="${activityPicturesPage.pictureUrl}" />
 ...
 <script>
     ...
     function uploadFile(){
         ...
         var ajaxUrl = "api/file/upload/activity/pictures";
         //alert(ajaxUrl);
         ...
         $.ajax({
             ...
             success: function (data) {
                 ...
                 $("#pictureUrl").val(src);//保存附件地址 originname +
